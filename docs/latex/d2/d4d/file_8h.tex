...
\begin{DoxyCompactItemize}
\item 
\#define \mbox{\hyperlink{file_8h_ab8bd63e7a74ee69778f78c27ea229ffd}{O\+F\+F\+\_\+T}}~int32\+\_\+t
\item 
\#define \mbox{\hyperlink{file_8h_a13626ef7288234ec5471d94d9f45e06a}{F\+T\+E\+LL}}~ftell
\item 
\#define \mbox{\hyperlink{file_8h_aea660a9139172ebd945a83b409fb4f67}{F\+S\+E\+EK}}~fseek
\item 
\#define \mbox{\hyperlink{file_8h_a47c1b9c9a7b4183ac4fd96dc5ca8e820}{S\+T\+AT}}~stat /$\ast$ always stat64 on Linux kernel 2.\+4+ $\ast$/
\item 
\#define \mbox{\hyperlink{file_8h_ab8c52c1b4c021ed3e6b6b677bd2ac019}{M\+O\+DE}}~0777
\item 
\#define \mbox{\hyperlink{file_8h_ae3a9312382ed2b2727e6135d2c92c6c9}{O\+F\+L\+AG}}~O\+\_\+\+R\+D\+WR $\vert$ O\+\_\+\+C\+R\+E\+AT $\vert$ O\+\_\+\+E\+X\+CL
\item 
\#define \mbox{\hyperlink{file_8h_a0e29f488071372aa0530842e60b64511}{C\+L\+O\+SE}}~close
\item 
\#define \mbox{\hyperlink{file_8h_a203d7e3133eb1746edc05f808cd7a799}{F\+S\+C\+A\+NF}}~fscanf
\item 
\#define \mbox{\hyperlink{file_8h_a709bde914e2b045cf1e1a00589b7291f}{O\+P\+EN}}(handle,  filename,  flag,  mode)~((($\ast$handle = open(filename, flag, mode)) == -\/1) ? errno \+: false)
\item 
\#define \mbox{\hyperlink{file_8h_a4dca483ca67560304887fab87e099cfd}{F\+O\+P\+EN}}(file,  filename,  mode)~((($\ast$file = fopen(filename, mode)) == N\+U\+LL) ? errno \+: false)
\end{DoxyCompactItemize}
\doxysubsection*{Typedefs}
\begin{DoxyCompactItemize}
\item 
typedef struct \mbox{\hyperlink{structfile__s}{file\+\_\+s}} \mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}}
\begin{DoxyCompactList}\small\item\em Data used to work with files. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{file_8h_ab8bd63e7a74ee69778f78c27ea229ffd}{O\+F\+F\+\_\+T}} \mbox{\hyperlink{file_8h_a6baaa46f530995a7d2a92e6a2f36e31d}{file\+\_\+find\+\_\+size}} (const \mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$file)
\begin{DoxyCompactList}\small\item\em Find the system storage size of a file. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{file_8h_a8b2072e6cfda1e851cc276596a92399e}{file\+\_\+read}} (\mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$file, const \mbox{\hyperlink{file_8h_ab8bd63e7a74ee69778f78c27ea229ffd}{O\+F\+F\+\_\+T}} offset, const \mbox{\hyperlink{file_8h_ab8bd63e7a74ee69778f78c27ea229ffd}{O\+F\+F\+\_\+T}} count, const bool change\+\_\+indicator)
...
bool \mbox{\hyperlink{file_8h_a0e1850e9b07b33909cae6abccb62c05e}{file\+\_\+read\+\_\+line}} (\mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$file, const bool change\+\_\+indicator)
\begin{DoxyCompactList}\small\item\em Read a line from file. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{file_8h_a34f09be9aec6687b498282e9601e8a9f}{file\+\_\+write}} (\mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$file, const \mbox{\hyperlink{file_8h_ab8bd63e7a74ee69778f78c27ea229ffd}{O\+F\+F\+\_\+T}} offset, const \mbox{\hyperlink{file_8h_ab8bd63e7a74ee69778f78c27ea229ffd}{O\+F\+F\+\_\+T}} count, const bool change\+\_\+indicator)
\begin{DoxyCompactList}\small\item\em Flush block of data from file buffer into system storage. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{file_8h_a984e2456adb02937dd7ae49fe19e68c4}{file\+\_\+replace\+\_\+buffer}} (\mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$file, \mbox{\hyperlink{memory_8h_a92a0a4edea422da0a8b5e6aa3556f1a6}{data\+\_\+t}} $\ast$data)
\begin{DoxyCompactList}\small\item\em Write block of data into file buffer. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{file_8h_a1d7164f3484f4c26ae3f38952df38323}{file\+\_\+close}} (\mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$file)
\begin{DoxyCompactList}\small\item\em Close open file and clean up memory. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{file_8h_a6f1e9af97c018371c0f86d56ca536a8c}{file\+\_\+open}} (\mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$$\ast$file, char $\ast$path)
...
{\footnotesize\ttfamily \#define C\+L\+O\+SE~close}
...
{\footnotesize\ttfamily \#define F\+O\+P\+EN(\begin{DoxyParamCaption}\item[{}]{file,  }\item[{}]{filename,  }\item[{}]{mode }\end{DoxyParamCaption})~((($\ast$file = fopen(filename, mode)) == N\+U\+LL) ? errno \+: false)}
...
{\footnotesize\ttfamily \#define F\+S\+C\+A\+NF~fscanf}
...
{\footnotesize\ttfamily \#define M\+O\+DE~0777}
...
{\footnotesize\ttfamily \#define O\+F\+F\+\_\+T~int32\+\_\+t}
...
{\footnotesize\ttfamily \#define O\+F\+L\+AG~O\+\_\+\+R\+D\+WR $\vert$ O\+\_\+\+C\+R\+E\+AT $\vert$ O\+\_\+\+E\+X\+CL}
...
{\footnotesize\ttfamily \#define O\+P\+EN(\begin{DoxyParamCaption}\item[{}]{handle,  }\item[{}]{filename,  }\item[{}]{flag,  }\item[{}]{mode }\end{DoxyParamCaption})~((($\ast$handle = open(filename, flag, mode)) == -\/1) ? errno \+: false)}
...
{\footnotesize\ttfamily \#define S\+T\+AT~stat /$\ast$ always stat64 on Linux kernel 2.\+4+ $\ast$/}



\doxysubsection{Typedef Documentation}
\mbox{\Hypertarget{file_8h_ab997eba9ca6001274a2916a7518ddca5}\label{file_8h_ab997eba9ca6001274a2916a7518ddca5}} 
\index{file.h@{file.h}!file\_t@{file\_t}}
\index{file\_t@{file\_t}!file.h@{file.h}}
\doxysubsubsection{\texorpdfstring{file\_t}{file\_t}}
{\footnotesize\ttfamily typedef struct \mbox{\hyperlink{structfile__s}{file\+\_\+s}}  \mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}}}
...
{\footnotesize\ttfamily void file\+\_\+close (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$}]{file }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \mbox{\hyperlink{file_8h_ab8bd63e7a74ee69778f78c27ea229ffd}{O\+F\+F\+\_\+T}} file\+\_\+find\+\_\+size (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$}]{file }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily bool file\+\_\+open (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$$\ast$}]{file,  }\item[{char $\ast$}]{path }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily bool file\+\_\+read (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$}]{file,  }\item[{const \mbox{\hyperlink{file_8h_ab8bd63e7a74ee69778f78c27ea229ffd}{O\+F\+F\+\_\+T}}}]{offset,  }\item[{const \mbox{\hyperlink{file_8h_ab8bd63e7a74ee69778f78c27ea229ffd}{O\+F\+F\+\_\+T}}}]{count,  }\item[{const bool}]{change\+\_\+indicator }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily bool file\+\_\+read\+\_\+line (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$}]{file,  }\item[{const bool}]{change\+\_\+indicator }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily void file\+\_\+replace\+\_\+buffer (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$}]{file,  }\item[{\mbox{\hyperlink{memory_8h_a92a0a4edea422da0a8b5e6aa3556f1a6}{data\+\_\+t}} $\ast$}]{data }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily bool file\+\_\+write (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{file_8h_ab997eba9ca6001274a2916a7518ddca5}{file\+\_\+t}} $\ast$}]{file,  }\item[{const \mbox{\hyperlink{file_8h_ab8bd63e7a74ee69778f78c27ea229ffd}{O\+F\+F\+\_\+T}}}]{offset,  }\item[{const \mbox{\hyperlink{file_8h_ab8bd63e7a74ee69778f78c27ea229ffd}{O\+F\+F\+\_\+T}}}]{count,  }\item[{const bool}]{change\+\_\+indicator }\end{DoxyParamCaption})}
